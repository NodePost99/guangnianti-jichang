...
```
[用户设备] ----(VLESS/Trojan)----> [国内中转入口] ----(通用中转线路)----> [海外落地 (原生住宅 IP)]
```
- **线路架构**：通用中转线路
- **延迟表现**：平均延迟 49ms - 82ms，黄金高峰期 0% 丢包率
...
| :--- | :--- | :--- | :--- | :--- |
| 🟢 香港 IEPL 01 | 49ms | 495.0 MB/s | 0% | 满速极清稳定 |
| 🟢 日本 东京 专线 | 92ms | 390.0 MB/s | 0% | 极清流畅 |
| 🟢 新加坡 专线 | 82ms | 400.0 MB/s | 0% | 极清流畅 |
| 🟢 台湾 台北 优化 | 61ms | 350.0 MB/s | 0% | 稳定解锁 |
| 🟡 美国 洛杉矶 优化 | 162ms | 180.0 MB/s | 0% | 高压可用 |
...
答：基于哨所探针 24H 采样，光年梯 (Guangnian) 晚高峰最高下载速率达到 495.0 MB/s，连通平稳。
...
👉 **[直达 光年梯 (Guangnian) 官方网站](https://ggmq.gntaff.com)**
